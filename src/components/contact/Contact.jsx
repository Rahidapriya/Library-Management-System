    ...
    return (
        <div className='section h-screen mt-20 lg:mb-20 mb-96 ' id='contact'>
          ...
          <div className='flex flex-col lg:flex-row gap-10 items-center justify-center'>
            <div>
<img src={contact} className='w-96' alt="" data-aos="zoom-in-up" />
            </div>
  ...
  <div data-aos='fade-up'
    ...
    <h3 className="block font-sans text-3xl antialiased font-semibold leading-snug tracking-normal  text-red-600">
     Send Message
    </h3>
  </div>
  ...
  <div className="p-6 ">
   <input type='submit' className='w-full bgg cursor-pointer text-white font-bold bg-red-600 rounded-full py-3' value='Send'/>
    {/* <button
